    ...
    for example in data:
        ...
        if example.is_bad_example:
            ...
            for column in example.word_columns:
                ...
                example.word_columns[start] = column + [[utility.word_ids[
            ...
            for remaining in range(word_num_cols, utility.FLAGS.max_word_cols):
                ...
                example.word_columns.append([[utility.word_ids[utility.dummy_token]] * utility.FLAGS.max_entry_length] *
                                            utility.FLAGS.max_elements)
