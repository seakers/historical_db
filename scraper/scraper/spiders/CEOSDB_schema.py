...
hasResolutionSummary = URIRef("http://ceosdb/schemas/relationship/hasResolutionSummary")
hasBestResolution = URIRef("http://ceosdb/schemas/relationship/hasBestResolution")
hasSwathSummary = URIRef("http://ceosdb/schemas/relationship/hasSwathSummary")
hasMaxSwath = URIRef("http://ceosdb/schemas/relationship/hasMaxSwath")
hasAccuracySummary = URIRef("http://ceosdb/schemas/relationship/hasAccuracySummary")
hasWavebandSummary = URIRef("http://ceosdb/schemas/relationship/hasWavebandSummary")
hasWaveband = URIRef("http://ceosdb/schemas/relationship/hasWaveband")